...
**Part 1 due: Monday, January 8th 11:00PM**

**Due: Wednesday, January 17th 11:00 PM**
...
```sh
$ git clone git@gitlab.cs.washington.edu:cse444-24wi/simple-db-MY_GITLAB_USERNAME.git
...
$ git remote add upstream git@gitlab.cs.washington.edu:cse444-24wi/simple-db.git
```
...
```sh
$ git remote -v
  origin  git@gitlab.cs.washington.edu:cse444-24wi/simple-db-username.git (fetch)
  origin  git@gitlab.cs.washington.edu:cse444-24wi/simple-db-username.git (push)
  upstream    git@gitlab.cs.washington.edu:cse444-24wi/simple-db.git (fetch)
  upstream    git@gitlab.cs.washington.edu:cse444-24wi/simple-db.git (push)
```
...
To git@gitlab.cs.washington.edu:cse444-24wi/simple-db-username.git
...
From gitlab.cs.washington.edu:cse444-24wi/simple-db
...
After executing the `turnInLab.sh` script, make sure to check your repository on GitLab to ensure that the tag has been property applied!  You may do this by visiting `https://gitlab.cs.washington.edu/cse444-24wi/simple-db-YOUR_USERNAME/tags`.
...
To git@gitlab.com:cse444-24wi/hw-answers-pirateninja.git
 - [deleted]         lab1
...
```sh
$ git clone git@gitlab.cs.washington.edu:cse444-24wi/simple-db-username.git confirmation_directory
